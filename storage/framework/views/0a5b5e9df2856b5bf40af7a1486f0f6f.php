        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col justify-between p-5 relative <?php echo e($curso->obrigatorio ? 'ring-2 ring-red-200' : ''); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($curso->obrigatorio): ?>
                    <span class="absolute top-3 right-3 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide bg-red-600 text-white rounded-full flex items-center gap-1 shadow-sm">
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($curso->obrigatorio): ?>
                        <span class="inline-block mb-2 px-3 py-1 text-[11px] font-medium rounded-full <?php echo e($corBadge); ?>">
                            <?php echo e($status); ?>

                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <a href="<?php echo e(route('aluno.cursos.show', $curso->id_curso)); ?>" class="group inline-block">
...
<?php endif; ?><?php /**PATH C:\Users\otvoa\Downloads\GearUp-postgresql-atualizado\GearUp-postgresql\resources\views/aluno/cursos.blade.php ENDPATH**/ ?>