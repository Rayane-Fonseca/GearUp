...
<?php $component->withAttributes(['titulo-pagina' => ''.e($aula->titulo).'','subtitulo-pagina' => ''.e($curso->titulo).'']); ?>
    ...
    <div x-data="aulaPlayer({
        ...
        <div x-data="{ sidebarOpen: false, moduloAberto: <?php echo e($aula->modulo_id ?? $aula->id_modulo ?? 'null'); ?> }" class="h-full flex flex-col overflow-hidden">
        ...
        <header class="bg-white border-b border-gray-100 px-3 sm:px-6 py-3 flex items-center justify-between gap-2 shadow-xs shrink-0 z-10">
            <div class="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
                <a href="<?php echo e(route('aluno.cursos.show', $curso->id_curso ?? $curso->id)); ?>" class="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-blue-600 transition-colors shrink-0">
                ...
                <h1 class="text-sm font-bold text-gray-900 truncate min-w-0"><?php echo e($curso->titulo); ?></h1>
            </div>
...
<?php endif; ?><?php /**PATH C:\Users\otvoa\Downloads\GearUp\resources\views/aluno/aulas/show.blade.php ENDPATH**/ ?>