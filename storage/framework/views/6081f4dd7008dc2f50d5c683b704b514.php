                            ...
                            <td class="px-6 py-3.5">
                                <div class="flex items-center gap-2 w-28">
                                    <div class="flex-1 bg-gray-100 rounded-full h-1.5">
                                        <div class="bg-blue-600 h-1.5 rounded-full" style="width: <?php echo e($colaborador->percentual); ?>%"></div>
                                    </div>
                                    <span class="font-semibold text-gray-600"><?php echo e($colaborador->percentual); ?>%</span>
                                </div>
                            </td>
                            <td class="px-6 py-3.5"><span class="px-2.5 py-1 rounded-md font-medium <?php echo e($corStatus); ?>"><?php echo e($colaborador->status); ?></span></td>
                        </tr>
...
<?php endif; ?>
<?php /**PATH C:\Users\otvoa\Downloads\GearUp-corrigido (1)\GearUp-corrigido (1)\GearUp-main\resources\views/admin/colaboradores.blade.php ENDPATH**/ ?>