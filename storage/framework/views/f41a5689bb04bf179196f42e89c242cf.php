...
<?php $component->withAttributes(['titulo-pagina' => 'Gerenciar Colaboradores','subtitulo-pagina' => 'Acompanhe o progresso de cada membro da equipe']); ?>
    <div class="p-8 max-w-7xl mx-auto space-y-6" x-data="{ modalAberto: false }">
        <form method="GET" action="<?php echo e(route('admin.colaboradores')); ?>" class="flex flex-wrap gap-3 items-center justify-between">
            <div class="flex gap-3 flex-1">
                <input type="text" name="busca" value="<?php echo e($busca); ?>" placeholder="Buscar colaborador..." class="flex-1 max-w-xs px-3.5 py-2.5 text-xs rounded-xl border border-gray-200 outline-none focus:border-blue-600">
                <select name="area" onchange="this.form.submit()" class="px-3.5 py-2.5 text-xs rounded-xl border border-gray-200 outline-none focus:border-blue-600">
                    ...
                    <option value="<?php echo e($a); ?>" <?php if($area===$a): echo 'selected'; endif; ?>><?php echo e($a); ?></option>
            ...
            <div class="flex items-center gap-3">
                <span class="text-xs text-gray-400 font-medium"><?php echo e($colaboradores->count()); ?> colaboradores</span>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('erro')): ?>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-3.5">
                            <div class="flex items-center gap-2.5">
                                <div class="w-7 h-7 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold shrink-0"><?php echo e($colaborador->iniciais()); ?></div>
                                <span class="font-semibold text-gray-800"><?php echo e($colaborador->nome); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-3.5 text-gray-500"><?php echo e($colaborador->cargo); ?></td>
                        <td class="px-6 py-3.5"><span class="px-2 py-0.5 bg-indigo-50 text-indigo-600 rounded-md font-medium"><?php echo e($colaborador->area); ?></span></td>
                        <td class="px-6 py-3.5 text-gray-500"><?php echo e($colaborador->email); ?></td>

                        <td class="px-6 py-3.5 text-right">
                            <form method="POST" action="<?php echo e(route('admin.colaboradores.destroy', $colaborador->id_usuario)); ?>"
                                onsubmit="return confirm('Tem certeza que deseja excluir <?php echo e($colaborador->nome); ?>? Essa ação não pode ser desfeita.');"
                                class="inline">
                                <?php echo csrf_field(); ?>
        ...
        <div x-show="modalAberto" x-cloak class="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
            <div @click.outside="modalAberto = false" class="bg-white rounded-2xl w-full max-w-md p-6 space-y-4">
                ...
                <form method="POST" action="<?php echo e(route('admin.colaboradores.store')); ?>" class="space-y-3">
                    <?php echo csrf_field(); ?>
                    <div>
...
<?php endif; ?><?php /**PATH C:\Users\otvoa\Downloads\GearUp-postgresql-atualizado\GearUp-postgresql\resources\views/admin/colaboradores.blade.php ENDPATH**/ ?>