        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="space-y-3 max-w-3xl">
                    <div class="flex items-center gap-2 flex-wrap">
                        <span class="px-3 py-1 text-[11px] font-medium text-gray-600 bg-gray-50 rounded-full border border-gray-100">
                            <?php echo e($curso->categoria ?? 'Geral'); ?>

                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($obrigatorio): ?>
                        ...
                        <span class="text-xs text-gray-400 flex items-center gap-1 font-medium">
                            ...
                            <?php echo e($curso->carga_horaria ?? '0'); ?>h de conteúdo
                        </span>
                    </div>
                ...
                <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 min-w-[200px] text-center space-y-1 shrink-0">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($curso->modulos->count()); ?></p>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\Users\otvoa\Downloads\GearUp-postgresql-atualizado\GearUp-postgresql\resources\views/aluno/cursos/show.blade.php ENDPATH**/ ?>