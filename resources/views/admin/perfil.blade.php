<x-admin-layout titulo-pagina="Perfil" subtitulo-pagina="Gerencie suas credenciais e preferências de administração">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 text-xs">
                            <div class="bg-gray-50 rounded-xl p-3">
                                ...
                                <p class="font-semibold text-gray-800 mt-0.5">{{ $usuario->nome }}</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3">
                            ...
                            <div class="bg-gray-50 rounded-xl p-3">
                                ...
                                <p class="font-semibold text-gray-800 mt-0.5">{{ $usuario->cargo ?? 'Gestor de Treinamento' }}</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3">
